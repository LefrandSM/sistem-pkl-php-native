...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/admin/humas.css">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <ul class="navbar-nav me-auto nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="humas.php">HUMAS <i class="fas fa-user"></i><span class="sr-only"></span></a>
          </li>
          <li class="nav-item">
    ...
    <div class="data">
      <div class="judul">
        <i class="fab fa-user"></i><h2>Humas</h2>
      </div>
    ...
    <!-- form -->
      ...
      <div class="tambah-button">
        <a href="../_config/admin/tambah_data_siswa.php" class="btn btn-primary mr-2">Tambah Humas <i class="fas fa-user-plus"></i></a>
